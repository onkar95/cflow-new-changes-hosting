        ...
        <div>
            ...
            <div className="blogDetails" >
                <div className="bolg_img">
                    <img src={`${blogData[Blog]?.image.url}`} alt=" is loading"></img>
                    {/* <img src={`https://cmsblogbackend.herokuapp.com${blogData[Blog]?.image.url}`} alt=" is loading"></img> */}
                </div>
                ...
                <div className="blog_text">
                    ...
                    {/* <img src={`https://cmsblogbackend.herokuapp.com${blogData[Blog]?.image.url}`} alt="" /> */}
                    <img src={`${blogData[Blog]?.image.url}`} alt="" />
                    {/* <p>{blogData[Blog]?.description}</p> */}
                ...
                <div className="blog_button">
                    <div >
                        ...
                        <p>{blogData[Blog - 1] && blogData[Blog - 1].title}</p>
                    </div>
