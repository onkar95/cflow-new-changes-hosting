...
import { useStyles } from './PlasterEstimation.mui'

const PlasterEstimation = ({ theme }) => {
  ...
  return (
    <div className='plaster-container'>
      {/* Upper Div */}
      <div className='upper-div'>
        ...
        <div className='left-div'>
          ...
          {count === 2 && (
            <>
              <div className='room-number'>Room 2</div>
...
export default PlasterEstimation
