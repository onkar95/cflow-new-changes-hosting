...
function Marble({ description,setDescription,getCart, theme, formData, modalopen, setModalOpen, newRequest, setNewRequest, data, setData, quantity, setQuantity, setOpenSaved, dropdownData }) {
 ...
 <div style={{ margin: "5px", marginTop: "20px" }}>
            ...
            </div>    <div className="cement-bottom-buttons">
