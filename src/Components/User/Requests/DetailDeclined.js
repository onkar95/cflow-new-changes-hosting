...
const DetailDeclined = ({theme, setCurrentSection,selectedTableItem}) => {
            ...
            <h3 className="back" onClick={()=>{setCurrentSection(2)}} style={{cursor:"pointer", color:theme?"black":""}}><ArrowBackIosIcon  style={theme === true ? { color: "black",height: '16px' } : {height: '16px'}}/>back</h3>
                ...
                <div className="content-container" style={theme?{backgroundColor:"#F8F8F8", color:"black"}:{}}>
                    <div className="order-details1">
                        ...
                        <div className="information">You have declined the pitch. You can no longer access the vendor's complete details.</div>
                        ...
                        <div className="declined-request-alternates-instruction1">
                            ...
                            <div className="declined-request-alternates-instruction">You have declined this vendor's pitch</div>
                        </div>}
                    ...
                    <div className="no-info">
                        <div className="no-info-wrapper">
                            <div className="no-info-first-div">
                                ...
                                <div className="no-info-description">You have declined the pitch. You can no longer access the vendor's complete details.</div>
                            </div>
                            <div className="declined-request-instruction"><img style={{width:"20px", marginBottom:"-5px"}} src={Rejected}></img> You have declined this vendor's pitch</div>
                        </div>
