...
import VendorDetails from './ViewDetailsSections/VendorDetails.js'


const DetailAccepted = ({theme, setCurrentSection,selectedTableItem,requestedVendorDetails}) => {
            ...
            <h3 className="back" onClick={()=>{setCurrentSection(2)}} style={{cursor:"pointer", color:theme?"black":""}}><ArrowBackIosIcon  style={theme === true ? { color: "black",height: '16px' } : {height: '16px'}}/>back</h3>
                ...
                <div className="content-container" style={theme?{backgroundColor:"#F8F8F8", color:"black"}:{}}>
                    <div className="order-details1">
                        ...
                        <div className="information">You have accepted the pitch. Go to vendor details tab to view the vendor's personal details.</div>
                        {window.screen.width<1050 && <div className="accepted-request-instruction"><img style={{width:"20px", marginBottom:"-5px"}} src={Accepted}></img> You have accepted a pitch for this request</div>}
                    ...
                    <div className="no-info">
                        <div className="no-info-wrapper">
                            <div className="no-info-first-div">
                                ...
                                <div className="no-info-description">You have accepted the pitch. Go to vendor details tab to view the vendor's complete details.</div>
                            </div>
                            <div className="accepted-request-instruction"><img style={{width:"20px", marginBottom:"-5px"}} src={Accepted}></img> You have accepted a pitch for this request</div>
                        </div>
                ...
                <div className="content-container" style={theme?{backgroundColor:"#F8F8F8", color:"black"}:{}}>
                    <div className="vendor-details">
                        <div className="vendor-first-part">
                            <div>
                                <div className="no-info-header">Vendor details</div>
                                <div className="information-accepted-vendor">You have accepted the pitch. The following are the vendor's complete details.</div>
                            </div>
                            <div className="accepted-request-instruction"><img style={{width:"20px", marginBottom:"-5px"}} src={Accepted}></img> You have accepted a pitch for this request</div>
                        </div>

                        <VendorDetails selectedTableItem={selectedTableItem} data={data} requestedVendorDetails={requestedVendorDetails} />
