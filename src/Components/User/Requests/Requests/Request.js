...
import RequestsUnavailable from './RequestsUnavailable'
...
const Request = ({
  ...
  setTemp_filter_new_requests,
  temp_filter_pitched_requests,
  setTemp_filter_pitched_requests,
  temp_filter_saved_requests,
  setTemp_filter_saved_requests,
  temp_filter,
  tableSwitch,
  setTableSwitch,
  userId,
  ...
  return (
    ...
    >
      <BreadCrumb userId={userId} theme={theme} />
      {userId === undefined ? (
        <RequestsUnavailable theme={theme} />
      ) : (
        <div className='request_containeruser'>
        <RequestStats theme={theme} recent_products={recent_products} setCurrentSection={setCurrentSection} setSelectedTableItem={setSelectedTableItem} pendingRequests={pendingRequests} acceptedRequests={acceptedRequests} rejectedRequests={rejectedRequests} pitchedRequests={pitchedRequests} savedRequests={savedRequests} newRequests={newRequests} Arrow={Arrow} SortArrow={SortArrow} SortArrow2={SortArrow2} SortArrow3={SortArrow3}/>
